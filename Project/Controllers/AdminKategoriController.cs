...
namespace Project.Controllers
{
    public class AdminKategoriController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CategoryID,title")] Categories category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategoryID,title")] Categories category)
        {
            if (ModelState.IsValid)
            {
